...
if (isset($tpl['status']))
{
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminExtras&amp;action=pjActionCreate" method="post" id="frmCreate" class="pj-form form" enctype="multipart/form-data">
		...
		<div class="clear_both">
			...
			<p>
				...
				<span class="pj-form-field-custom pj-form-field-custom-before">
					...
					<input type="text" name="price" class="pj-form-field number w100" data-msg-required="<?php __('tr_field_required'); ?>" data-msg-number="<?php __('pj_number_validation');?>"/>
				</span>
			</p>
            <?php
            foreach ($tpl['lp_arr'] as $v)
            ...
            ?>
            <p>
				<label class="title"><?php __('lblExtraImage'); ?></label>
				<span class="inline_block">
