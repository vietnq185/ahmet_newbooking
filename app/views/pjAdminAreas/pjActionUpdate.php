...
if (isset($tpl['status']))
{
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminAreas&amp;action=pjActionUpdate" method="post" id="frmUpdateArea" class="form pj-form frmArea">
		<input type="hidden" name="area_update" value="1" />
	...
	<div id="dialogSetPlaceName" title="<?php __('lblSetPlaceName');?>" style="display: none">
		<form action="" class="form pj-form">
			...
			<div class="clear_both">
				<p>
					<label class="title" for="order_index"><?php __('lblIcon'); ?></label>
