...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice(__('infoUpdateStationTitle', true, false), __('infoUpdateStationBody', true, false));
	?>
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminStations&amp;action=pjActionUpdate" method="post" id="frmUpdateStation" class="form pj-form">
		<input type="hidden" name="station_update" value="1" />
		...
		<div class="clear_both">
			...
			<p>
				...
				<span class="inline-block">
					<input type="text" name="free_starting_fee_in_km" id="free_starting_fee_in_km" class="pj-form-field field-int w80" value="<?php echo pjSanitize::clean($tpl['arr']['free_starting_fee_in_km'])?>" data-msg-digits="<?php __('pj_digits_validation');?>" />
				</span>
			</p>
			<p>
				<label class="title"><?php __('lblStationMaxBaseStationDistance'); ?></label>
				<span class="inline-block">
					<input type="text" name="max_base_station_distance" id="max_base_station_distance" class="pj-form-field field-int w80" value="<?php echo pjSanitize::clean($tpl['arr']['max_base_station_distance'])?>" data-msg-digits="<?php __('pj_digits_validation');?>" />
				</span>km
			</p>
			<p>
				<label class="title"><?php __('lblStationMinTravelDistance'); ?></label>
				<span class="inline-block">
					<input type="text" name="min_travel_distance" id="min_travel_distance" class="pj-form-field field-int w80" value="<?php echo pjSanitize::clean($tpl['arr']['min_travel_distance'])?>" data-msg-digits="<?php __('pj_digits_validation');?>" />
				</span>km
			</p>
