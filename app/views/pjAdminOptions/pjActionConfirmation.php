												...
												if ($tpl['arr'][$i]['tab_id'] == 3 && (int) $tpl['arr'][$i]['is_visible'] === 1 && (strpos($tpl['arr'][$i]['key'], 'admin') === false) && (strpos($tpl['arr'][$i]['key'], 'email') > -1))
												{
													...
													<tr class="pj-table-row-odd<?php echo $rowClass; ?>" style="<?php echo $rowStyle; ?>">
														<td width="35%" valign="top">
															...
															<span class="fs10">
																<?php 
																if(in_array($tpl['arr'][$i]['key'], array('o_email_confirmation','o_email_payment','o_email_cancel', 'o_email_client_account', 'o_email_client_account_message', 'o_email_forgot_message', 'o_email_reminder', 'o_email_return_reminder', 'o_email_arrival_confirmation')))
																{
