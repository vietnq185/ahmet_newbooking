...
//		$arr[] = 'rev';
	...
	static public function calPrice($one_way_price, $return_price, $extra_price, $return, $return_discount, $option_arr, $payment_method, $voucher_code)
	{
		...
		$deposit = in_array($payment_method, array('creditcard', 'paypal', 'authorize', 'saferpay')) || is_null($payment_method) ? (($total * $option_arr['o_deposit_payment']) / 100): 0;
		$deposit = round($deposit);
		return compact('extra_price', 'sub_total', 'discount', 'tax', 'total', 'deposit');
	}
